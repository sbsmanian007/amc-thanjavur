  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
        {loading && <ActivityIndicator animating={true} color={Colors.blue} />}
      </View>
      {appointments.length === 0 && !loading &&  <View style={{display: 'flex',marginVertical: 15,  justifyContent: 'center', alignItems: 'center'}}>
